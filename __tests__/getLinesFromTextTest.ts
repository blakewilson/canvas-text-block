...
test('it should fragment a word larger than the max width of the text block', () => {
    ...
    const text = 'This is my text withalongwordthatiswiderthanthewidthofthecanvas. This test should fragment and hyphenate the word.'
    const expectedLines = [
        'This is my text',
...
test('it should add an ellipsis at the very last line', () => {
    ...
    const text = 'this is my very long text block. This text block should be prefixed with a set of ellipsis'
    const expectedLines = [
        'this is my',
        'very long...'
    ]
